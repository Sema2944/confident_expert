...
EN_TO_RU: dict[str, str] = {
    ...
    "knee-high boots": "сапоги до колена", "knee-high": "до колена",
    "combat boots": "берцы", "platform": "на платформе",
    "lace-up": "на шнуровке", "slip-on": "слипоны", "slip-ons": "слипоны",
    "sandals": "сандалии", "loafers": "лоферы", "heels": "туфли на каблуке",
    "flats": "балетки", "mules": "мюли", "slides": "шлёпанцы",
    "slippers": "тапочки", "oxfords": "оксфорды", "oxford": "оксфорды", "derby": "дерби",
    "pumps": "лодочки", "chelsea boots": "челси",
